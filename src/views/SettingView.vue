...
<template>
  <NSpace vertical>
    <NCard title="服务器配置">
      <NSpace vertical>
        ...
        <NInputGroup>
          ...
          <NInputNumber placeholder="18021" v-model:value="data.port" />
        </NInputGroup>
      </NSpace>
    </NCard>
    <NCard title="外观">
      <NSpace style="display: flex">
        <NButtonGroup>
          ...
          <NButton
            @click="data.darkMode = false"
            :type="!data.darkMode ? 'primary' : 'default'"
          >
            <template #icon>
    ...
    <NCard title="恢复">
      <NSpace vertical>
        <NPopconfirm @positive-click="resetData">
          <template #trigger>
            <NButton type="error">重置控制面板</NButton>
          </template>
          是否要重置控制面板？
        </NPopconfirm>
      </NSpace>
